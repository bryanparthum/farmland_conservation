...
reshape wide title cost nature farmland meals fruit veggies dist food, j(alt) i(treatment block card card_id card_dcreate)
...
gen image_food = "C:\\Users\\bparthum\\Box\\farmland_conservation\\experiment_design\\store\\fruit_" + string(fruit1) + "_veggies_" + string(veggies1) + ".png" 
gen image_dist = "C:\\Users\\bparthum\\Box\\farmland_conservation\\experiment_design\\store\\miles_" + string(dist1) + ".png" if treatment == "miles"
replace image_dist = "C:\\Users\\bparthum\\Box\\farmland_conservation\\experiment_design\\store\\minutes_" + string(dist1) + ".png" if treatment == "minutes"
...
** ORDER 
order treatment block card card_id title1 cost1 nature1 farmland1 fruit1 veggies1 dist1 food1 ///
	  ...
	  title2 cost2 nature2 farmland2 fruit2 veggies2 dist2 food2
